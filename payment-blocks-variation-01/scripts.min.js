...
jQuery(document).ready(function(l){l("#toggle-content").click(function(){l(".toggle-paragraph").toggleClass("active"),l(this).toggleClass("active")})}),$(document).ready(function(){$('[data-toggle="tooltip"]').tooltip()}),$(document).ready(function(){$("#terms-collapse").on("hide.bs.collapse",function(){$(".more-terms").html('Read More <i class="fa fa-caret-down"></i> ')}),$("#terms-collapse").on("show.bs.collapse",function(){$(".more-terms").html('Show Less <i class="fa fa-caret-up"></i> ')}),$("#live-dealer-collapse").on("hide.bs.collapse",function(){$(".more-dealer").html('Read More <i class="fa fa-caret-down"></i> ')}),$("#live-dealer-collapse").on("show.bs.collapse",function(){$(".more-dealer").html('Show Less <i class="fa fa-caret-up"></i> ')}),$("#tech-collapse-1").on("hide.bs.collapse",function(){$("#more-1").html('<i class="fa fa-caret-down pull-right"></i> ')}),$("#tech-collapse-1").on("show.bs.collapse",function(){$("#more-1").html('<i class="fa fa-caret-up pull-right"></i> ')}),$("#tech-collapse-2").on("hide.bs.collapse",function(){$("#more-2").html('<i class="fa fa-caret-down pull-right"></i> ')}),$("#tech-collapse-2").on("show.bs.collapse",function(){$("#more-2").html('<i class="fa fa-caret-up pull-right"></i> ')}),$("#tech-collapse-3").on("hide.bs.collapse",function(){$("#more-3").html('<i class="fa fa-caret-down pull-right"></i> ')}),$("#tech-collapse-3").on("show.bs.collapse",function(){$("#more-3").html('<i class="fa fa-caret-up pull-right"></i> ')}),$("#tech-collapse-4").on("hide.bs.collapse",function(){$("#more-4").html('<i class="fa fa-caret-down pull-right"></i> ')}),$("#tech-collapse-4").on("show.bs.collapse",function(){$("#more-4").html('<i class="fa fa-caret-up pull-right"></i> ')}),$("#tech-collapse-5").on("hide.bs.collapse",function(){$("#more-5").html('<i class="fa fa-caret-down pull-right"></i> ')}),$("#tech-collapse-5").on("show.bs.collapse",function(){$("#more-5").html('<i class="fa fa-caret-up pull-right"></i> ')}),$("#tech-collapse-6").on("hide.bs.collapse",function(){$("#more-6").html('<i class="fa fa-caret-down pull-right"></i> ')}),$("#tech-collapse-6").on("show.bs.collapse",function(){$("#more-6").html('<i class="fa fa-caret-up pull-right"></i> ')})}),$(document).ready(function(){$("[id^=carousel-selector-]").click(function(){var l=this.id.substr(this.id.lastIndexOf("-")+1),l=parseInt(l);$("#myCarousel").carousel(l)}),$("#myCarousel").on("slide.bs.carousel",function(l){$("#slider-thumbs .row div.active").removeClass("active"),$("#slider-thumbs .row div:eq("+$(l.relatedTarget).index()+")").addClass("active")}),$(".thumbnail-content").each(function(){$(this).height()<96&&$(this).css("top","calc(50% - 24px)")}),$(".flip .card .flip-anchor").click(function(){$(this).parent().parent().parent().parent().find(".card").toggleClass("flipped")});var a=$(".scroll"),l=$(".top-anchor");a.click(function(l){l.preventDefault(),$("body,html").animate({scrollTop:$(this.hash).offset().top},1e3)}),l.click(function(l){l.preventDefault(),$("body,html").animate({scrollTop:0},1e3)}),$(window).scroll(function(){var l=$(this).scrollTop();a.each(function(){$(this.hash).offset().top-20<=l&&($(this).parent().addClass("active"),$(this).parent().siblings().removeClass("active"))});var e=screen.height;e<l?$(".back-to-top").css("display","block"):$(".back-to-top").css("display","none")})}),$("#item-text-slider").carousel({interval:!1}),$("main-content").scrollspy({target:"#sticky-menu"});
!function(e,n){var l=[],f=[],s={_version:"3.5.0",_config:{classPrefix:"",enableClasses:!0,enableJSClass:!0,usePrefixes:!0},_q:[],on:function(e,n){var s=this;setTimeout(function(){n(s[e])},0)},addTest:function(e,n,s){f.push({name:e,fn:n,options:s})},addAsyncTest:function(e){f.push({name:null,fn:e})}},c=function(){};c.prototype=s,c=new c;var o,a,t,i=n.documentElement,r="svg"===i.nodeName.toLowerCase();(function(){var e,n,s,o,a,t,i;for(i in f)if(f.hasOwnProperty(i)){if(e=[],(n=f[i]).name&&(e.push(n.name.toLowerCase()),n.options&&n.options.aliases&&n.options.aliases.length))for(s=0;s<n.options.aliases.length;s++)e.push(n.options.aliases[s].toLowerCase());for(o="function"==typeof n.fn?n.fn():n.fn,a=0;a<e.length;a++)1===(t=e[a].split(".")).length?c[t[0]]=o:(!c[t[0]]||c[t[0]]instanceof Boolean||(c[t[0]]=new Boolean(c[t[0]])),c[t[0]][t[1]]=o),l.push((o?"":"no-")+t.join("-"))}})(),o=l,a=i.className,t=c._config.classPrefix||"",r&&(a=a.baseVal),c._config.enableJSClass&&(n=new RegExp("(^|\\s)"+t+"no-js(\\s|$)"),a=a.replace(n,"$1"+t+"js$2")),c._config.enableClasses&&(a+=" "+t+o.join(" "+t),r?i.className.baseVal=a:i.className=a),delete s.addTest,delete s.addAsyncTest;for(var p=0;p<c._q.length;p++)c._q[p]();e.Modernizr=c}(window,document);
function trimAndConvert(r){return r=r.toFixed(2).toString()}jQuery(document).ready(function(){jQuery(".textbox").val(""),jQuery(".error").css("visibility","hidden"),jQuery(".textbox").bind("keypress",function(r){var e=[8,9,13,35,36,37,39].join(",").match(new RegExp(r.which));!r.which||48<=r.which&&r.which<=57||48==r.which&&jQuery(this).attr("value")||e||r.preventDefault()}),jQuery(".textbox").bind("blur",function(r){return""==jQuery(this).val()&&jQuery(this).hasClass("required")?(jQuery(this).closest(".item-group").children(".error").css("visibility","visible"),jQuery(this).addClass("err")):(jQuery(this).closest(".item-group").children(".error").css("visibility","hidden"),jQuery(this).removeClass("err")),!1}),jQuery("#game-contribution").bind("blur",function(r){return(jQuery(this).val()<1||100<jQuery(this).val())&&""!=jQuery(this).val()?(jQuery(this).closest(".item-group").children(".error").css("visibility","visible"),jQuery(this).addClass("err")):(jQuery(this).closest(".item-group").children(".error").css("visibility","hidden"),jQuery(this).removeClass("err")),!1}),jQuery("#calculator").submit(function(){jQuery("#dep-wage");var r=jQuery("#bonus-wage"),e=jQuery("#play-wage"),s=jQuery("#free-money"),i=jQuery("#total-money");jQuery(".error").css("visibility","hidden"),jQuery(".textbox").removeClass("err"),jQuery("#depositResult").css("display","none"),jQuery("#bonusResult").css("display","none"),jQuery("#totalResult").css("display","none");var t=!0,u=jQuery("#deposit-amount").val(),n=jQuery("#bonus-percent").val(),a=jQuery("#wagering").val(),l=jQuery("#bonus-options").val(),o=jQuery("#game-contribution").val();""==u&&(t=!1,jQuery("#depositError").css("visibility","visible"),jQuery("#deposit-amount").addClass("err")),""==n&&(t=!1,jQuery("#bonusError").css("visibility","visible"),jQuery("#bonus-percent").addClass("err")),""==a&&(t=!1,jQuery("#wageringError").css("visibility","visible"),jQuery("#wagering").addClass("err")),(o<1||100<o)&&""!=o&&(t=!1,jQuery("#contributionError").css("visibility","visible"),jQuery("#game-contribution").addClass("err")),""==o&&(o=100);var y=parseInt(u)/100*parseInt(n),n=y+parseInt(u),u=jQuery("#bonus-calculator #results").css("display");return t?("none"==u&&jQuery("#bonus-calculator #results").slideDown(),s.text(trimAndConvert(y)),i.text(trimAndConvert(n)),"bonus"==l&&(y=100/o*y*parseInt(a),r.text(trimAndConvert(y)),jQuery("#bonusResult").css("display","block")),"deposit-bonus"==l&&(a=n*(100/o)*parseInt(a),e.text(trimAndConvert(a)),jQuery("#totalResult").css("display","block"))):"block"==u&&jQuery("#bonus-calculator #results").slideUp(),!1}),jQuery("#fmCalculator").submit(function(){var r="",e=(jQuery("#fmAmount"),jQuery("#fmWagering"),jQuery("#fmBonusOptions"),jQuery("#fmBonusWager")),s=jQuery("#fmBonusEst");jQuery("#fmEstWinnings");jQuery(".error").css("visibility","hidden"),jQuery(".textbox").removeClass("err"),e.css("display","none"),s.css("display","none");var i=!0,t=jQuery("#fmAmount").val(),r=jQuery("#fmWagering").val(),u=jQuery("#fmBonusOptions").val(),n=jQuery("#fmEstWinnings").val(),a=jQuery("#fmCalculator #game-contribution").val();""==t&&(i=!1,jQuery("#fmAmountError").css("visibility","visible"),jQuery("#fmAmount").addClass("err")),""==r&&(i=!1,jQuery("#fmWageringError").css("visibility","visible"),jQuery("#fmWagering").addClass("err")),"fmBonusWinnings"==u&&""==n&&(i=!1,jQuery("#fmEstError").css("visibility","visible"),jQuery("#fmEstWinnings").addClass("err")),(a<1||100<a)&&""!=a&&(formOk=!1,jQuery("#fmCalculator #contributionError").css("visibility","visible"),jQuery("#fmCalculator #game-contribution").addClass("err")),""==a&&(a=100);e=jQuery("#bonus-calculator #fmResults").css("display");return i?("none"==e&&jQuery("#bonus-calculator #fmResults").slideDown(),"fmBonus"==u&&(i=parseInt(t)*(100/a)*parseInt(r),jQuery("#fmBonusWagerResult").text(trimAndConvert(i)),jQuery("#fmBonusWager").css("display","block")),"fmBonusWinnings"==u&&(r=(parseInt(t)+parseInt(n))*(100/a)*parseInt(r),jQuery("#fmBonusEstResult").text(trimAndConvert(r)),s.css("display","block"))):"block"==e&&jQuery("#bonus-calculator #fmResults").slideUp(),!1}),jQuery("ul.ctabs").each(function(r){var s=jQuery(this).find("> li > a");jQuery("ul.ctabs li:first").addClass("active").fadeIn("fast"),jQuery("ul.ctabs li:first a").addClass("active").fadeIn("fast"),jQuery("ul.ctabs-content li:first").addClass("active").fadeIn("fast"),s.click(function(r){var e=jQuery(this).attr("href")+"Tab";"#"==e.charAt(0)&&(r.preventDefault(),s.removeClass("active"),jQuery(this).addClass("active"),jQuery(e).show().addClass("active").siblings().hide().removeClass("active"))})})});
!function(h){h.fn.bcSwipe=function(t){var i={threshold:50};return t&&h.extend(i,t),this.each(function(){function e(t){s&&(t=t.touches[0].pageX,t=n-t,Math.abs(t)>=i.threshold&&(function(){this.removeEventListener("touchmove",e),n=null,s=!1}(),h(this).find(".item.active").length<1||(0<t?h(this).carousel("next"):h(this).carousel("prev"))))}var n,s=!1;"ontouchstart"in document.documentElement&&this.addEventListener("touchstart",function(t){1==t.touches.length&&(n=t.touches[0].pageX,s=!0,this.addEventListener("touchmove",e,!1,{passive:!0}))},!1,{passive:!0})}),this}}(jQuery);
